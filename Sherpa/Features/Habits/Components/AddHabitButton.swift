...
struct AddHabitButton: View {
    ...
    var body: some View {
        ...
        .buttonStyle(AddHabitButtonStyle())
        .accessibilityLabel(L10n.string("habits.addButton.label"))
    }
}

struct AddHabitButtonStyle: ButtonStyle {
    func makeBody(configuration: Configuration) -> some View {
        AddHabitButtonStyleBody(configuration: configuration)
    }

    private struct AddHabitButtonStyleBody: View {
